...
import { Menu, Play, Clock, Heart, User, FileText, Settings, History, CreditCard } from 'lucide-react-native';
...
export default function HomeScreen() {
  ...
  const renderFilmCard = ({ item, index }: { item: any; index: number }) => (
    <TouchableOpacity style={[styles.filmCard, index === 0 && styles.firstCard]}>
  ...
  const renderTrendingCard = ({ item, index }: { item: any; index: number }) => (
    <TouchableOpacity style={[styles.trendingCard, index === 0 && styles.firstCard]}>
